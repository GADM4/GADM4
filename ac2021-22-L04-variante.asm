...
; *********************************************************************************
; *
; * Modulo: 	ac-P05-lab05-variante.asm
...
; *		porto, cuja unidade de escrita mínima é um byte, a forma de 
...
; *
; *
; * Nota : 	igual a ac-P05-lab05-rotinas.asm mas usando uma única rotina para escrever nos 
...
inicio:		MOV	SP, SP_inicial	; inicializa SP para a palavra a seguir
					;à última da pilha
...
hexa_display:	PUSH	R0		; guarda registo
...
;* Destrói: R0
;* Notas: --
hexa_low:	PUSH	R1		; guarda registos
		PUSH	R2
		PUSH	R3
...
;* Destrói: R0
;* Notas: --
hexa_high:	PUSH	R1		; guarda registos
		PUSH	R2
		PUSH	R3
		MOV	R1, nibble_3_0	; máscara para isolar os 4 bits de menor peso
		AND	R0, R1		; limita valor de entrada a valores entre 0 e FH
